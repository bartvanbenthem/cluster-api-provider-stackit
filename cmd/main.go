...
import (
	...
	"github.com/bartvanbenthem/cluster-api-provider-stackit/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "062c9dd1.cluster.x-k8s.io",
	...
	if err := (&controller.StackitClusterIdentityReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "Failed to create controller", "controller", "stackitclusteridentity")
		os.Exit(1)
	}
