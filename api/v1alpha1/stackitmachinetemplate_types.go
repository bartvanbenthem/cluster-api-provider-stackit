...
type StackitMachineTemplateResource struct {
	// spec is the specification for the StackitMachines created from this template.
	// +required
...
type StackitMachineTemplateSpec struct {
	// template is the object used to create StackitMachines from this StackitMachineTemplate.
	// +required
...
func init() {
	SchemeBuilder.Register(func(s *runtime.Scheme) error {
		s.AddKnownTypes(SchemeGroupVersion, &StackitMachineTemplate{}, &StackitMachineTemplateList{})
		return nil
	})
}
