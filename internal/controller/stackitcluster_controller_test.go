...
var _ = Describe("StackitCluster Controller", func() {
	Context("When reconciling a resource", func() {
		...
		It("should wait without error when the StackitCluster has no owner Cluster yet", func() {
			// This StackitCluster has no owner Cluster, so Reconcile must return early
